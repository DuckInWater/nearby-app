...
Meetup.update_location = function(zip_lat, zip_lon) {
  Meetup['zip_lat'] = zip_lat;
  Meetup['zip_lon'] = zip_lon;
...
// Non-promise version. Commented out to run the promise version.
// Meetup.getDataFromAPI = function (user_lat, user_lon) {
//   Meetup.update_location(user_lat, user_lon);
//   var api_data = $.getJSON(Meetup.ev_query, function(data) {
//     return data;
//   debugger;
//   });
// }
...
Meetup.getDataFromAPI = function (user_lat, user_lon) {
  ...
  return new Promise(function(resolve,reject)) {
    $.getJSON(Meetup.ev_query, resolve(data));
  }
  });
}
  ...
  // Run the API request
// Meetup.getDataFromAPI(user_lat, user_long, Meetup.ev_query, function(data) {
//   return data;
      // var event_data = [];
      //
